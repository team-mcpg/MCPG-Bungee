...
public class Debugger extends Command implements TabExecutor {
    ...
    private void sendHelp(CommandSender sender){
        ...
        sender.sendMessage(new TextComponent("§6/debugger exceptions:§r Débug des erreurs java."));
        sender.sendMessage(new TextComponent("§6/debugger jedis:§r Débug des erreurs jedis."));
    }
